...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
                 ...
                 names='Vehicle_Type',
                 title="Vehicle Expenditure Share by Vehicle Types during Recessions"
                )
        )

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ur_type_sales = recession_data.groupby('Vehicle_Type')['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
            figure=px.bar(ur_type_sales,
            x='Vehicle_Type',
            y='Automobile_Sales',
            title='Effect of Unemployment Rate of Vehicle Type and Sales'
            )
        )
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas,
            x='Year',
            y='Automobile_Sales',
            title='Average Automobile Sales during non-recession years'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(figure=px.line(monthly_sales,
            x='Month',
            y='Automobile_Sales',
            title='Average Automobile Sales during Non-Recession Months'))
